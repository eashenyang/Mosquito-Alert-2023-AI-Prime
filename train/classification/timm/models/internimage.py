...
from timm.models.ops_dcnv3 import modules as opsm
...
# from timm.models.config_internimage.config import 
class Config():
...
@register_model
def internimage_s(pretrained=False, 
                  config_path='./timm/models/config_internimage/internimage_s_1k_224.yaml', 
                  **kwargs):
...
@register_model
def internimage_l(pretrained=False, 
                  config_path='./timm/models/config_internimage/internimage_l_22kto1k_384.yaml', 
                  **kwargs):
    num_classes = kwargs.pop("num_classes", 1000)
    with open(config_path, 'r') as f:
        config = yaml.load(f, Loader=yaml.FullLoader)
...
def internimage_b(pretrained=False, 
                  config_path='./timm/models/config_internimage/internimage_b_1k_224.yaml', 
                  **kwargs):
    num_classes = kwargs.pop("num_classes", 1000)
    with open(config_path, 'r') as f:
        config = yaml.load(f, Loader=yaml.FullLoader)
