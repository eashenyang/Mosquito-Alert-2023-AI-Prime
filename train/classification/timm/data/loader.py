...
def create_loader(
    ...
    if is_training:
        ...
        samples_weight = np.array([cls_weight[t] for t in dataset.targets])
        samples_weight = torch.from_numpy(samples_weight)
        samples_weight = samples_weight.double()
        print(samples_weight)
        weighted_sampler =DistributedProxySampler(ExhaustiveWeightedRandomSampler(samples_weight, 
                                                                                  len(samples_weight)))
    #########################
